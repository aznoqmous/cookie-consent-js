...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return CookieConsent; });\n/* harmony import */ var _rules_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./rules.json */ \"./src/rules.json\");\nvar _rules_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./rules.json */ \"./src/rules.json\", 1);\n/* harmony import */ var _cookies__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cookies */ \"./src/cookies.js\");\n/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils.js */ \"./src/utils.js\");\n/* harmony import */ var _lang_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lang.js */ \"./src/lang.js\");\n/* harmony import */ var _cookie_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cookie.svg */ \"./src/cookie.svg\");\n/* harmony import */ var _cookie_svg__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_cookie_svg__WEBPACK_IMPORTED_MODULE_4__);\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _iterableToArray(iter) { if (typeof Symbol !== \"undefined\" && iter[Symbol.iterator] != null || iter[\"@@iterator\"] != null) return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\n\n\n\nvar CookieConsent = /*#__PURE__*/function () {\n  function CookieConsent() {\n    _classCallCheck(this, CookieConsent);\n\n    this.config = {\n      services: Object.keys(_rules_json__WEBPACK_IMPORTED_MODULE_0__),\n      title: _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get(\"popupTitle\"),\n      disclaimer: _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get(\"popupDisclaimer\"),\n      legalNoticeText: _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get('legalNotice'),\n      legalNoticeUrl: \"/mentions-legales\",\n      // to override \n      popupDetailsTitle: _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get('popupDetailsTitle'),\n      popupDetailsDisclaimer: _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get('popupDetailsDisclaimer'),\n      cookieColor: 'black'\n    };\n    this.defaultServices = Object.fromEntries(this.config.services.map(function (s) {\n      return [s, false];\n    }));\n    this.defaultServices.functionnal = true;\n    this.getBannedScriptRules();\n    this.getBannedCookieRules();\n    this.getBannedIframeRules();\n    this.observe();\n    this.overrideCookieSetter();\n  }\n\n  _createClass(CookieConsent, [{\n    key: \"init\",\n    value: function init(config) {\n      var _this = this;\n\n      this.config = Object.assign(this.config, config);\n      _utils_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].DOMLoaded().then(function () {\n        _this.buildPopup();\n      });\n      this.deleteBannedCookies();\n    }\n    /**\r\n     * Data\r\n     */\n\n  }, {\n    key: \"getData\",\n    value: function getData() {\n      return Object.assign(this.defaultServices, JSON.parse(_cookies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].get(CookieConsent.key)));\n    }\n  }, {\n    key: \"saveData\",\n    value: function saveData(data) {\n      _cookies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].set(CookieConsent.key, JSON.stringify(data));\n    }\n  }, {\n    key: \"isDataSet\",\n    value: function isDataSet() {\n      return !!_cookies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].get(CookieConsent.key);\n    }\n  }, {\n    key: \"enabledServices\",\n    get: function get() {\n      return ['functionnal'].concat(_toConsumableArray(this.config.services));\n    }\n  }, {\n    key: \"allowedRules\",\n    get: function get() {\n      var data = this.getData();\n      return Object.fromEntries(Object.keys(_rules_json__WEBPACK_IMPORTED_MODULE_0__).filter(function (k) {\n        return !data || typeof data[k] == 'undefined' || data[k] == 'true';\n      }).map(function (k) {\n        return [k, _rules_json__WEBPACK_IMPORTED_MODULE_0__[k]];\n      }));\n    }\n  }, {\n    key: \"disallowedRules\",\n    get: function get() {\n      var data = this.getData();\n      return Object.fromEntries(Object.keys(_rules_json__WEBPACK_IMPORTED_MODULE_0__).filter(function (k) {\n        return data && typeof data[k] !== 'undefined' && data[k] != 'true';\n      }).map(function (k) {\n        return [k, _rules_json__WEBPACK_IMPORTED_MODULE_0__[k]];\n      }));\n    }\n    /**\r\n     * Popup\r\n     */\n\n  }, {\n    key: \"buildPopup\",\n    value: function buildPopup() {\n      var _this2 = this;\n\n      this.popup = this.create(document.body, {\n        className: \"cookie-consent-popup\"\n      }, \"div\");\n      if (!this.isDataSet()) this.popup.classList.add('active');\n      var cookieFigure = this.create(this.popup, {}, \"figure\");\n      var cookieImg = this.create(cookieFigure, {\n        innerHTML: _cookie_svg__WEBPACK_IMPORTED_MODULE_4___default.a,\n        style: \"fill: \".concat(this.config.cookieColor)\n      }, 'figure');\n      var title = this.create(this.popup, {\n        innerHTML: this.config.title\n      });\n      var disclaimer = this.create(this.popup, {\n        innerHTML: this.config.disclaimer,\n        className: \"disclaimer\"\n      });\n      var buttons = this.create(this.popup, {\n        className: \"buttons\"\n      });\n      var acceptAll = this.create(buttons, {\n        innerHTML: _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get('allowAll'),\n        className: \"allow\"\n      }, 'button');\n      var denyAll = this.create(buttons, {\n        innerHTML: _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get('disallowAll'),\n        className: \"disallow\"\n      }, 'button');\n      var customize = this.create(buttons, {\n        innerHTML: _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get('customize')\n      }, 'button');\n      acceptAll.addEventListener('click', function () {\n        _this2.acceptAll();\n      });\n      denyAll.addEventListener('click', function () {\n        _this2.denyAll();\n      });\n      cookieFigure.addEventListener('click', function () {\n        _this2.setPopupDetailsActive();\n      });\n      customize.addEventListener('click', function () {\n        _this2.setPopupDetailsActive();\n      });\n      var legalNotice = this.create(this.popup, {\n        innerHTML: this.config.legalNoticeText,\n        href: this.config.legalNoticeUrl\n      }, \"a\");\n      this.buildDetailsPopup();\n    }\n  }, {\n    key: \"buildDetailsPopup\",\n    value: function buildDetailsPopup() {\n      var _this3 = this;\n\n      this.popupDetailsContainer = this.create(document.body, {\n        className: \"cookie-consent-popup-details\"\n      }, \"div\");\n      this.popupDetails = this.create(this.popupDetailsContainer, {}, 'form');\n      this.popupDetails.addEventListener('submit', function (e) {\n        e.preventDefault();\n      });\n      var title = this.create(this.popupDetails, {\n        innerHTML: this.config.popupDetailsTitle\n      }, 'strong');\n      var disclaimer = this.create(this.popupDetails, {\n        innerHTML: this.config.popupDetailsDisclaimer,\n        className: \"disclaimer\"\n      });\n      var buttons = this.create(this.popupDetails, {\n        className: \"buttons\"\n      });\n      var acceptAll = this.create(buttons, {\n        innerHTML: _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get('allowAll'),\n        className: \"allow\"\n      }, 'button');\n      var denyAll = this.create(buttons, {\n        innerHTML: _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get('disallowAll'),\n        className: \"disallow\"\n      }, 'button');\n      acceptAll.addEventListener('click', function () {\n        _this3.acceptAll();\n      });\n      denyAll.addEventListener('click', function () {\n        _this3.denyAll();\n      });\n      var services = this.create(this.popupDetails, {\n        className: \"services\"\n      });\n      this.addedTypes = {};\n      Object.keys(_rules_json__WEBPACK_IMPORTED_MODULE_0__).filter(function (r) {\n        return _this3.enabledServices.includes(r);\n      }).map(function (key) {\n        return _this3.addedTypes[_rules_json__WEBPACK_IMPORTED_MODULE_0__[key].type] = false;\n      });\n      this.enabledServices.sort(function (a, b) {\n        if (_rules_json__WEBPACK_IMPORTED_MODULE_0__[a].type == 'functionnal') return -1;\n        if (_rules_json__WEBPACK_IMPORTED_MODULE_0__[b].type == 'functionnal') return 1;else return _rules_json__WEBPACK_IMPORTED_MODULE_0__[a].type > _rules_json__WEBPACK_IMPORTED_MODULE_0__[b].type ? 1 : -1;\n      }).map(function (k) {\n        _this3.addService(k, services);\n      });\n      this.updatePopupDetails();\n      var legalNotice = this.create(this.popupDetails, {\n        innerHTML: this.config.legalNoticeText,\n        href: this.config.legalNoticeUrl\n      }, \"a\");\n    }\n  }, {\n    key: \"addService\",\n    value: function addService(k, parent) {\n      var _this4 = this;\n\n      var data = this.getData();\n      var lang = _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get(k);\n      var serviceType = _rules_json__WEBPACK_IMPORTED_MODULE_0__[k].type;\n\n      if (!this.addedTypes[serviceType]) {\n        this.create(parent, {\n          innerHTML: _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get(\"types\")[serviceType],\n          className: \"type\"\n        }, 'small');\n        this.addedTypes[serviceType] = true;\n      }\n\n      var service = this.create(parent, {\n        className: \"service\"\n      });\n      var serviceDetails = this.create(service, {\n        className: \"details\"\n      });\n      this.create(serviceDetails, {\n        innerHTML: lang.name\n      }, 'strong');\n      this.create(serviceDetails, {\n        innerHTML: lang.description\n      }, 'small');\n      var input = this.create(service, {\n        name: k,\n        value: data[k],\n        required: _rules_json__WEBPACK_IMPORTED_MODULE_0__[k].mandatory,\n        type: 'hidden'\n      }, 'input');\n      var buttons = this.create(service, {\n        className: \"buttons\"\n      });\n      var allow = this.create(buttons, {\n        innerHTML: _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get(\"allow\"),\n        disabled: _rules_json__WEBPACK_IMPORTED_MODULE_0__[k].mandatory,\n        className: \"allow\"\n      }, \"button\");\n      allow.addEventListener('click', function () {\n        input.value = true;\n\n        _this4.savePopupDetailsData();\n\n        _this4.updatePopupDetails();\n      });\n\n      if (!_rules_json__WEBPACK_IMPORTED_MODULE_0__[k].mandatory) {\n        var disallow = this.create(buttons, {\n          innerHTML: _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get(\"disallow\"),\n          className: \"disallow\"\n        }, \"button\");\n        disallow.addEventListener('click', function () {\n          input.value = false;\n\n          _this4.savePopupDetailsData();\n\n          _this4.updatePopupDetails();\n        });\n      }\n    }\n  }, {\n    key: \"accept\",\n    value: function accept(key) {\n      var field = this.popupDetails.querySelector(\".service input[name=\\\"\".concat(key, \"\\\"]\"));\n      field.value = true;\n      field.parentElement.querySelector('.allow').classList.add('active');\n      field.parentElement.querySelector('.disallow').classList.remove('active');\n      this.updatePopupDetails();\n      this.savePopupDetailsData();\n    }\n  }, {\n    key: \"deny\",\n    value: function deny(key) {\n      this.popupDetails.querySelector(\".service input[name=\\\"\".concat(key, \"\\\"]\")).value = false;\n      this.updatePopupDetails();\n      this.savePopupDetailsData();\n    }\n  }, {\n    key: \"acceptAll\",\n    value: function acceptAll() {\n      _toConsumableArray(this.popupDetails.querySelectorAll('.service input[type=\"hidden\"]')).map(function (input) {\n        return input.value = true;\n      });\n\n      this.updatePopupDetails();\n      this.savePopupDetailsData();\n      this.popup.classList.remove('active');\n    }\n  }, {\n    key: \"denyAll\",\n    value: function denyAll() {\n      _toConsumableArray(this.popupDetails.querySelectorAll('.service input[type=\"hidden\"]:not([required])')).map(function (input) {\n        return input.value = false;\n      });\n\n      this.updatePopupDetails();\n      this.savePopupDetailsData();\n      this.popup.classList.remove('active');\n    }\n  }, {\n    key: \"updatePopupDetails\",\n    value: function updatePopupDetails() {\n      _toConsumableArray(this.popupDetails.querySelectorAll('.service')).map(function (service) {\n        var isAllowed = service.querySelector('input[type=\"hidden\"]').value == \"true\";\n        var allow = service.querySelector('.allow');\n        var disallow = service.querySelector('.disallow');\n\n        if (isAllowed) {\n          allow.classList.add('active');\n          if (disallow) disallow.classList.remove('active');\n        } else {\n          allow.classList.remove('active');\n          if (disallow) disallow.classList.add('active');\n        }\n      });\n    }\n  }, {\n    key: \"savePopupDetailsData\",\n    value: function savePopupDetailsData() {\n      var datas = this.getPopupDetailsData();\n      this.saveData(datas);\n      this.getBannedCookieRules();\n      this.deleteBannedCookies();\n    }\n  }, {\n    key: \"getPopupDetailsData\",\n    value: function getPopupDetailsData() {\n      var formData = new FormData(this.popupDetails);\n      return Object.fromEntries(_toConsumableArray(formData.entries()).map(function (entry) {\n        return [entry[0], entry[1]];\n      }));\n    }\n  }, {\n    key: \"setPopupDetailsActive\",\n    value: function setPopupDetailsActive() {\n      var _this5 = this;\n\n      this.popupDetailsContainer.classList.add('active');\n\n      var hidePopupDetails = function hidePopupDetails(e) {\n        if (!_this5.popupDetails.contains(e.target)) {\n          _this5.popupDetailsContainer.classList.remove('active');\n\n          document.removeEventListener('click', hidePopupDetails);\n        }\n      };\n\n      setTimeout(function () {\n        document.addEventListener('click', hidePopupDetails);\n      });\n    }\n  }, {\n    key: \"create\",\n    value: function create(parent) {\n      var attributes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};\n      var tagName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : \"div\";\n      var el = document.createElement(tagName);\n\n      for (var key in attributes) {\n        el[key] = attributes[key];\n      }\n\n      parent.appendChild(el);\n      return el;\n    }\n    /**\r\n     * Scripts\r\n     * */\n\n  }, {\n    key: \"getBannedScriptRules\",\n    value: function getBannedScriptRules() {\n      var _this6 = this;\n\n      this.bannedScriptRules = [];\n      Object.values(this.disallowedRules).filter(function (rule) {\n        return rule.scripts;\n      }).map(function (rule) {\n        var _this6$bannedScriptRu;\n\n        return (_this6$bannedScriptRu = _this6.bannedScriptRules).push.apply(_this6$bannedScriptRu, _toConsumableArray(rule.scripts));\n      });\n      console.log(this.bannedScriptRules);\n    }\n  }, {\n    key: \"isScriptBanned\",\n    value: function isScriptBanned(script) {\n      return this.bannedScriptRules.some(function (rule) {\n        return script.src && script.src.match(rule) || !script.innerHTML.match(\"CookieConsent\") && script.innerHTML.match(rule);\n      });\n    }\n    /**\r\n     * Cookies\r\n     */\n\n  }, {\n    key: \"getBannedCookieRules\",\n    value: function getBannedCookieRules() {\n      var _this7 = this;\n\n      this.bannedCookieRules = [];\n      Object.values(this.disallowedRules).filter(function (rule) {\n        return rule.cookies;\n      }).map(function (rule) {\n        var _this7$bannedCookieRu;\n\n        return (_this7$bannedCookieRu = _this7.bannedCookieRules).push.apply(_this7$bannedCookieRu, _toConsumableArray(rule.cookies));\n      });\n    }\n  }, {\n    key: \"deleteBannedCookies\",\n    value: function deleteBannedCookies() {\n      var _this8 = this;\n\n      Object.keys(_cookies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getAll()).filter(function (key) {\n        return _this8.bannedCookieRules.some(function (rule) {\n          return key.match(rule);\n        });\n      }).map(function (key) {\n        return _cookies__WEBPACK_IMPORTED_MODULE_1__[\"default\"].remove(key, \"/\");\n      });\n    }\n    /**\r\n     * Iframes\r\n     */\n\n  }, {\n    key: \"getBannedIframeRules\",\n    value: function getBannedIframeRules() {\n      var _this9 = this;\n\n      this.bannedIframeRules = [];\n      Object.values(this.disallowedRules).filter(function (rule) {\n        return rule.iframes;\n      }).map(function (rule) {\n        var _this9$bannedIframeRu;\n\n        return (_this9$bannedIframeRu = _this9.bannedIframeRules).push.apply(_this9$bannedIframeRu, _toConsumableArray(rule.iframes));\n      });\n    }\n  }, {\n    key: \"isIframeBanned\",\n    value: function isIframeBanned(iframe) {\n      return this.bannedIframeRules.some(function (rule) {\n        return iframe.src && iframe.src.match(rule);\n      });\n    }\n  }, {\n    key: \"iframeBannedBy\",\n    value: function iframeBannedBy(iframe) {\n      var _this10 = this;\n\n      var matchingRules = this.bannedIframeRules.filter(function (rule) {\n        return iframe.src.match(new RegExp(rule));\n      });\n      if (!matchingRules.length) return false;\n      var matchingRule = matchingRules[0];\n      var matchingServices = Object.keys(_rules_json__WEBPACK_IMPORTED_MODULE_0__).filter(function (r) {\n        return _this10.enabledServices.includes(r);\n      }).filter(function (r) {\n        return _rules_json__WEBPACK_IMPORTED_MODULE_0__[r].iframes;\n      }).filter(function (r) {\n        return _rules_json__WEBPACK_IMPORTED_MODULE_0__[r].iframes && _rules_json__WEBPACK_IMPORTED_MODULE_0__[r].iframes.includes(matchingRule);\n      });\n      return matchingServices.length ? matchingServices[0] : false;\n    }\n  }, {\n    key: \"disableIframe\",\n    value: function disableIframe(iframe) {\n      var _this11 = this;\n\n      if (!iframe.src) return null;\n      var key = this.iframeBannedBy(iframe);\n      iframe.setAttribute('data-src', iframe.src);\n      iframe.removeAttribute('src');\n      iframe.disabled = true;\n      iframe.classList.add('cookie-consent-blocked');\n      var styles = window.getComputedStyle(iframe);\n      var figureIframe = this.create(iframe.parentElement, {\n        className: \"cookie-consent-iframe\",\n        style: \"width: \".concat(styles.width, \"; height: \").concat(styles.height)\n      }, 'figure');\n      this.create(figureIframe, {\n        innerHTML: _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get(\"iframeBlocked\").replace(\"%s\", _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get(key).name)\n      });\n      var allowButton = this.create(figureIframe, {\n        innerHTML: _lang_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"].get(\"allow\")\n      }, 'button');\n      allowButton.addEventListener('click', function () {\n        _this11.accept(key);\n\n        window.location.reload();\n      });\n      iframe.parentElement.insertBefore(figureIframe, iframe);\n      iframe.parentElement.insertBefore(iframe, figureIframe);\n    }\n    /** \r\n     * MISC \r\n     * */\n\n  }, {\n    key: \"observe\",\n    value: function observe() {\n      var _this12 = this;\n\n      new MutationObserver(function (mutations) {\n        ;\n\n        _toConsumableArray(mutations).map(function (m) {\n          ;\n\n          _toConsumableArray(m.addedNodes).filter(function (n) {\n            return n.tagName == \"SCRIPT\" && _this12.isScriptBanned(n);\n          }).map(function (n) {\n            return n.type = \"javascript/blocked\";\n          });\n\n          _toConsumableArray(m.addedNodes).filter(function (n) {\n            return n.tagName == 'IFRAME' && _this12.isIframeBanned(n);\n          }).map(function (n) {\n            return _this12.disableIframe(n);\n          });\n        });\n      }).observe(document.head, {\n        attributes: true,\n        childList: true,\n        subtree: true\n      });\n      document.addEventListener('DOMContentLoaded', function () {\n        ;\n\n        _toConsumableArray(document.querySelectorAll('iframe')).filter(function (iframe) {\n          return _this12.isIframeBanned(iframe);\n        }).map(function (iframe) {\n          return _this12.disableIframe(iframe);\n        });\n      });\n    }\n  }, {\n    key: \"overrideCookieSetter\",\n    value: function overrideCookieSetter() {\n      var cookieSetterOrig = document.__lookupSetter__(\"cookie\");\n\n      var cookieGetterOrig = document.__lookupGetter__(\"cookie\");\n\n      var self = this;\n      this.getBannedCookieRules();\n      Object.defineProperty(document, 'cookie', {\n        set: function set(value) {\n          if (!value.match(/cookie_consent_js/) && self.bannedCookieRules.some(function (rule) {\n            return value.match(rule);\n          })) {\n            return;\n          }\n\n          return cookieSetterOrig.apply(document, arguments);\n        },\n        get: function get() {\n          return cookieGetterOrig.apply(document);\n        },\n        configurable: true\n      });\n    }\n  }], [{\n    key: \"key\",\n    get: function get() {\n      return \"cookie_consent\";\n    }\n  }]);\n\n  return CookieConsent;\n}();\n\n\n\n//# sourceURL=webpack:///./src/cookie-consent.js?");
...
/*!************************!*\
  !*** ./src/rules.json ***!
  \************************/
/*! exports provided: functionnal, google, gtm, facebook, youtube, vimeo, default */
/***/ (function(module) {

eval("module.exports = JSON.parse(\"{\\\"functionnal\\\":{\\\"type\\\":\\\"functionnal\\\",\\\"mandatory\\\":true},\\\"google\\\":{\\\"type\\\":\\\"statistic\\\",\\\"scripts\\\":[\\\"google\\\",\\\"gtag\\\"],\\\"cookies\\\":[\\\"^__utm\\\",\\\"^_ga\\\",\\\"^_gid\\\"]},\\\"gtm\\\":{\\\"type\\\":\\\"api\\\",\\\"scripts\\\":[\\\"googletagmanager\\\"],\\\"cookies\\\":[\\\"^_gcl_au\\\",\\\"^_gat_\\\"]},\\\"facebook\\\":{\\\"type\\\":\\\"statistic\\\",\\\"scripts\\\":[\\\"fbq\\\",\\\"facebook\\\"],\\\"cookies\\\":[\\\"^_fb\\\",\\\"^datr\\\",\\\"^fr\\\",\\\"^reg_ext_ref\\\",\\\"^reg_fb_gate\\\",\\\"^reg_fb_ref\\\",\\\"^sb\\\",\\\"^wd\\\",\\\"^x-src\\\"]},\\\"youtube\\\":{\\\"type\\\":\\\"video\\\",\\\"iframes\\\":[\\\"youtube.com\\\"]},\\\"vimeo\\\":{\\\"type\\\":\\\"video\\\",\\\"iframes\\\":[\\\"vimeo.com\\\"]}}\");\n\n//# sourceURL=webpack:///./src/rules.json?");
